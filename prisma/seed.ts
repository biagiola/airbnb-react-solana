...
async function main() {
  ...
  const listing1 = await prisma.listing.create({
    data: {
      ...
      description: 'Beautiful modern apartment in the heart of downtown with stunning city views. Perfect for business travelers and couples looking for a luxurious stay.',
  ...
  const listing2 = await prisma.listing.create({
    data: {
      ...
      description: 'Charming beach house just steps away from the ocean. Wake up to the sound of waves and enjoy breathtaking sunsets from your private deck.',
  ...
  const listing3 = await prisma.listing.create({
    data: {
      ...
      description: 'Escape to this peaceful mountain cabin surrounded by nature. Perfect for hiking enthusiasts and those seeking tranquility away from city life.',
      imageSrc: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?w=800',
  ...
  const listing4 = await prisma.listing.create({
    data: {
      ...
      description: 'Stunning penthouse with panoramic city views, modern amenities, and rooftop access. Experience luxury living at its finest.',
      imageSrc: 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800',
      category: 'Lux',
      roomCount: 3,
      bathroomCount: 3,
      guestCount: 6,
  ...
  const listing5 = await prisma.listing.create({
    data: {
      ...
      description: 'Unique stay in a converted historic windmill. This one-of-a-kind property offers a blend of history and modern comfort.',
  ...
  const listing6 = await prisma.listing.create({
    data: {
      ...
      description: 'Luxurious desert villa with private pool and stunning desert landscape views. Perfect for a peaceful getaway under the stars.',
  ...
  const listing7 = await prisma.listing.create({
    data: {
      ...
      description: 'Private bungalow on a tropical island with direct beach access. Enjoy crystal clear waters and pristine white sand beaches.',
      imageSrc: 'https://images.unsplash.com/photo-1520637836862-4d197d17c90a?w=800',
      category: 'Islands',
      roomCount: 2,
      bathroomCount: 2,
      guestCount: 4,
  ...
  const listing8 = await prisma.listing.create({
    data: {
      ...
      description: 'Experience the magic of sleeping in an ice hotel. This unique accommodation offers an unforgettable Arctic adventure.',
